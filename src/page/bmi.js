            ...
            <div className="card">
                ...
                <div className="card-body">
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <button type="submit" className="w-100 btn btn-secondary mt-4 mb-3 text-light">Hitung</button>
                    </form>
                </div>
                <div className="card-footer">
                    <h2 className="text-center mb-3">Hasil</h2>
                    <button className="w-100 alert alert-secondary text-danger" name="result">{this.state.hasil}</button>
                </div>
            </div>
            </div>
        )
